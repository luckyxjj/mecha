...
-- Records of banner
-- ----------------------------
INSERT INTO `banner` VALUES (1, '首页banner', 'upload\\1559260065510NT1QfUBNaG.png', 'upload\\1559260065519na7wbgHmDY.png', '1212', 1, 1, NULL, '2019-05-26 15:16:56', '2019-05-31 07:47:45');
...
CREATE TABLE `buying`  (
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '买机甲表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `issue`  (
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '机甲设备发布表' ROW_FORMAT = Dynamic;
...
INSERT INTO `issue` VALUES (6, 'test', 'tttt', '11', '北京市', '北京市', '东城区', NULL, 22.00, '2019-05-08 00:00:00', 'upload\\1559259593806bdyDBFtCtS.png,upload\\1559259593814d0KB9bIdmB.png,upload\\1559259593818Rdmg7lyiUw.png', '77', 1, '44', '55', '66', '33', 0, 1, NULL, '2019-05-31 07:39:53', '2019-05-31 07:39:53');
