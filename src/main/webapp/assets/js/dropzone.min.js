			...
			j = (function(o) {
				...
				n.prototype.defaultOptions = {
					...
					fallback: function() {
						...
						if(!r) {
							r = n.createElement('<div class="dz-msg"><span></span></div>');
				...
				n.prototype.init = function() {
					...
					if(this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-msg")) {
						this.element.appendChild(n.createElement('<div class="dz-default dz-msg"><span>' + this.options.dictDefaultMessage + "</span></div>"))
					}
					...
					this.clickableElements.forEach(function(y) {
						return x.listeners.push({
							...
							events: {
								click: function(z) {
									if((y !== x.element) || (z.target === x.element || n.elementInside(z.target, x.element.querySelector(".dz-msg")))) {
